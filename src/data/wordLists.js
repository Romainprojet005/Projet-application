...
export const wordThemes = {
  ...
  hot: {
    ...
    pairs: [
      ...
      { civilian: 'Latex', undercover: 'Vinyle' },
      { civilian: 'Préservatif', undercover: 'Imperméable' },
      { civilian: 'Kama-sutra', undercover: 'Manuel de yoga' },
      { civilian: 'Plug anal', undercover: 'Bouchon de baignoire' },
      { civilian: 'Érection', undercover: 'Tour de Pise' },
      { civilian: 'Lotion chauffante', undercover: 'Baume musculaire' },
      { civilian: 'Fesses', undercover: 'Joues' },
      { civilian: 'Seins', undercover: 'Coussins' },
      { civilian: 'Voyeur', undercover: 'Observateur' },
      { civilian: 'Fellation', undercover: 'Flûte enchantée' },
      { civilian: 'Trio', undercover: 'Ménage à trois' },
      { civilian: 'Lapdance', undercover: 'Câlin assis' },
      { civilian: 'Sex friend', undercover: 'Meilleur ami' },
      { civilian: 'Cunnilingus', undercover: 'Pique-nique en sous-bois' },
      { civilian: 'Clitoris', undercover: 'Bouton d\'ascenseur' },
      { civilian: 'Échangisme', undercover: 'Troc entre voisins' },
      { civilian: 'Sperme', undercover: 'Gel coiffant' },
      { civilian: 'Gode', undercover: 'Saucisson' },
      { civilian: 'Testicules', undercover: 'Noisettes' },
      { civilian: 'Fétichisme des pieds', undercover: 'Réflexologie' },
      { civilian: 'Masturbation', undercover: 'Passe-temps solitaire' },
      { civilian: 'OnlyFans', undercover: 'Abonnement premium' },
      { civilian: 'Orgie', undercover: 'Buffet collectif' },
      { civilian: 'Sexologue', undercover: 'Psy de couple' },
      { civilian: 'Libido', undercover: 'Énergie de vie' },
      { civilian: 'Pubis', undercover: 'Petit gazon' },
      { civilian: 'Pénis', undercover: 'Crayon magique' },
      { civilian: 'Vagin', undercover: 'Tirelire en velours' },
      { civilian: 'Sadomasochisme', undercover: 'Jeu de rôle costaud' },
      { civilian: 'Pénétration', undercover: 'Porte ouverte' },
      { civilian: 'Éjaculation', undercover: 'Feu d\'artifice express' },
      { civilian: 'Dépucelage', undercover: 'Grande première' },
      { civilian: 'Sodomie', undercover: 'Porte de derrière' },
      { civilian: 'Camgirl', undercover: 'Streameuse mode' },
      { civilian: 'Exhibitionnisme', undercover: 'Passion du grand air' },
      { civilian: 'Dominatrice', undercover: 'Cheffe très stricte' },
      { civilian: 'Pornhub', undercover: 'Bibliothèque culturelle' },
      { civilian: 'Fisting', undercover: 'Poignée de main poussée' },
      { civilian: 'Nipple clamp', undercover: 'Pince à linge déco' },
      { civilian: 'Gorge profonde', undercover: 'Avaleur de sabre' },
      { civilian: 'Soin facial', undercover: 'Hydratation express' },
      { civilian: 'Tétons', undercover: 'Boutons de veste' },
      { civilian: 'Branlette', undercover: 'Solo improvisé' },
      { civilian: 'Nudité intégrale', undercover: 'Tenue d\'Adam et Ève' },
      { civilian: 'Érecteur de Noël', undercover: 'Sapin gonflable' },
      { civilian: 'Pilule contraceptive', undercover: 'Vitamine du soir' },
      { civilian: 'Vagin denté', undercover: 'Piège à souris intime' },
      { civilian: 'Sexualité tantrique', undercover: 'Yoga du soir' },
      { civilian: 'Cuckolding', undercover: 'Spectateur VIP' },
      { civilian: 'Lactation érotique', undercover: 'Petit-déjeuner maison' },
      { civilian: 'Sado-maso doux', undercover: 'Punition câline' },
      { civilian: 'Sex positive', undercover: 'Optimiste de la vie' },
      { civilian: 'Polyamour', undercover: 'Fan de tout le monde' },
      { civilian: 'Nudiste intégral', undercover: 'Économe en vêtements' },
    ],
  },
};
