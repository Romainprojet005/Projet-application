...
export const EMOJI_QUIZ_ITEMS = [
  ...
  { id: 'jungle_book',    emojis: ['🦁', '🌿', '🐻'], answer: 'Le Livre de la Jungle',    category: 'film',         hint: 'Mowgli — Baloo et Bagheera' },
  ...
  // ── JEUX VIDÉO ─────────────────────────────────────────────────────
  { id: 'jv_mario',       emojis: ['🍄', '👨', '⭐'], answer: 'Super Mario',              category: 'jeu_video',    hint: 'Nintendo — plombier rouge, Mushroom Kingdom' },
  { id: 'jv_sonic',       emojis: ['🔵', '⚡', '💨'], answer: 'Sonic',                    category: 'jeu_video',    hint: 'SEGA — hérisson bleu à vitesse supersonique' },
  { id: 'jv_zelda',       emojis: ['⚔️', '🛡️', '🌿'], answer: 'Zelda',                   category: 'jeu_video',    hint: 'Nintendo — Link et la princesse Zelda, Hyrule' },
  { id: 'jv_pokemon',     emojis: ['⚡', '🐭', '🎮'], answer: 'Pokémon',                  category: 'jeu_video',    hint: 'Nintendo — dresser des monstres de poche' },
  { id: 'jv_minecraft',   emojis: ['⛏️', '🏗️', '💎'], answer: 'Minecraft',               category: 'jeu_video',    hint: 'Mojang — construction en blocs cubiques' },
  { id: 'jv_fortnite',    emojis: ['🔫', '⛏️', '🌀'], answer: 'Fortnite',                category: 'jeu_video',    hint: 'Epic Games — battle royale, island, construire' },
  { id: 'jv_gta',         emojis: ['🚗', '🔫', '🌆'], answer: 'GTA',                      category: 'jeu_video',    hint: 'Rockstar — monde ouvert, crime, Los Santos' },
  { id: 'jv_cod',         emojis: ['🔫', '💥', '🪖'], answer: 'Call of Duty',             category: 'jeu_video',    hint: 'Activision — FPS militaire, guerre moderne' },
  { id: 'jv_fifa',        emojis: ['⚽', '🎮', '🏆'], answer: 'FIFA',                     category: 'jeu_video',    hint: 'EA Sports — simulation de football mondial' },
  { id: 'jv_pac',         emojis: ['🟡', '👻', '🍒'], answer: 'Pac-Man',                  category: 'jeu_video',    hint: 'Namco 1980 — boule jaune mange des fantômes' },
  { id: 'jv_tetris',      emojis: ['🧩', '📦', '⬇️'], answer: 'Tetris',                   category: 'jeu_video',    hint: 'Alexeï Pajitnov — pièces qui tombent, puzzle' },
  { id: 'jv_among_us',    emojis: ['🚀', '🔴', '🔪'], answer: 'Among Us',                 category: 'jeu_video',    hint: 'InnerSloth — imposteur sur un vaisseau spatial' },
  { id: 'jv_god_war',     emojis: ['⚔️', '🔥', '👹'], answer: 'God of War',               category: 'jeu_video',    hint: 'PlayStation — Kratos, mythologie grecque et nordique' },
  { id: 'jv_mario_kart',  emojis: ['🏎️', '🍌', '⭐'], answer: 'Mario Kart',               category: 'jeu_video',    hint: 'Nintendo — course de karts avec objets' },
  { id: 'jv_halo',        emojis: ['🔵', '🔫', '🚀'], answer: 'Halo',                     category: 'jeu_video',    hint: 'Xbox — Master Chief, batailles spatiales contre les Covenants' },
  { id: 'jv_tomb',        emojis: ['🏹', '🌿', '🏛️'], answer: 'Tomb Raider',              category: 'jeu_video',    hint: 'Crystal Dynamics — Lara Croft, archéologue aventurière' },
  { id: 'jv_mgs',         emojis: ['📦', '🔫', '🌿'], answer: 'Metal Gear Solid',         category: 'jeu_video',    hint: 'Konami — Solid Snake, infiltration en boîte en carton' },
  { id: 'jv_ac',          emojis: ['🗡️', '🎭', '🦅'], answer: "Assassin's Creed",         category: 'jeu_video',    hint: 'Ubisoft — confrérie d\'assassins à travers l\'Histoire' },
  { id: 'jv_ff',          emojis: ['⚔️', '✨', '🌌'], answer: 'Final Fantasy',             category: 'jeu_video',    hint: 'Square Enix — RPG épique, magie et épées géantes' },
  { id: 'jv_rdr',         emojis: ['🤠', '🐴', '🔫'], answer: 'Red Dead Redemption',      category: 'jeu_video',    hint: 'Rockstar — cowboy dans l\'Ouest américain' },
];
...
export const EMOJI_CATEGORIES = {
  ...
  jeu_video:    { label: 'Jeux Vidéo',  emoji: '🎮', color: '#10B981' },
};
